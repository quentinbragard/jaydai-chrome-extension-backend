...
def test_sign_in_success(test_client, mock_supabase):
    ...
    # Print the response for debugging
    # print(f"Sign in response: {response.json()}")
...
# Skip the test_get_current_user and test_get_current_user_unauthorized tests for now
# as they require more complex mocking of middleware